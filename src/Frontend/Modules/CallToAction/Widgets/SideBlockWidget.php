 ...
 */
class SideBlockWidget extends Widget
{
    /**
     * Execute the extra
     */
    ...
    {
        // get calltoactions
        $calltoactions = FrontendCallToActionModel::getAllSideBlockWidgets();
        ...
        // assign comments
        $this->tpl->assign('widgetCallToActionSideBlock', $calltoactions);
    }
}
