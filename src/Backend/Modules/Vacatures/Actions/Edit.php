...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendVacaturesModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendVacaturesModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->meta->setUrlCallBack('Backend\Modules\Vacatures\Engine\Model', 'getUrl', array($this->record['id']));
