...
/**
 * This is the category-action, it will display the overview of Over ons categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendOverOnsModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('OverOns', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('OverOns', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendOverOnsModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendOverOnsModel::getAllByCategory(
