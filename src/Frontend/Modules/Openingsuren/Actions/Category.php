...
namespace Frontend\Modules\Openingsuren\Actions;
...
/**
 * This is the category-action, it will display the overview of Openingsuren categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendOpeningsurenModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Openingsuren', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Openingsuren', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendOpeningsurenModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendOpeningsurenModel::getAllByCategory(
