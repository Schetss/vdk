...
class Index extends Block
{
    ...
    private function getData()
    {
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Openingsuren');
        $this->pagination['limit'] = $this->get('fork.settings')->get('Openingsuren', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendOpeningsurenModel::getAllCount();
        ...
        // get articles
        $this->items = FrontendOpeningsurenModel::getAll(
