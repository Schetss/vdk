...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        $this->record = BackendServiceModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Service\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
