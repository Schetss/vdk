...
class AddCategory extends ActionAdd
{
    ...
    private function loadForm()
    {
        ...
        $this->meta->setURLCallback('Backend\Modules\Vacatures\Engine\Model', 'getURLForCategory');
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendVacaturesModel::getMaximumCategorySequence() + 1;

                // save the data
                $item['id'] = BackendVacaturesModel::insertCategory($item);
