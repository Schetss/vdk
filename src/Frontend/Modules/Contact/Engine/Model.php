...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Contact', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Contact', 'Detail');
    ...
    /**
     * Get all directieleden used
     *
     * @return array
     */
    public static function getAllDirectie()
    {
         $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, naam AS name, functie as function, telefoon as tel, email as email
             FROM contact
             WHERE category_id = 1
      ...
      /**
     * Get all verkoopsleden used
     *
     * @return array
     */
    public static function getAllVerkoop()
    {
         $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, naam AS name, functie as function, telefoon as tel, email as email
             FROM contact
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Contact', 'category') . '/' . $item['url'];
