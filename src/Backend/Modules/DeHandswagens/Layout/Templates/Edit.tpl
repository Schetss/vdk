...
<div class="pageTitle">
    <h2>{$lblDeHandswagens|ucfirst}: {$lblEdit}</h2>
</div>
                ...
                <tr>
                    <td id="leftColumn">
                        ...
                        <div class="box">
                            ...
                            <div class="box">
                                <div class="heading">
                                    <h3>
                                        <label for="pdffile">{$lblPdffile|ucfirst}</label>
                                    </h3>
                                </div>
                                <div class="options">
                                    {option:item.pdffile}
                                        <p><a href="{$FRONTEND_FILES_URL}/de_handswagens/files/{$item.pdffile}">{$lblWatchFile}</a></p>
                                    {/option:item.pdffile}
                                    {$filePdffile} {$filePdffileError}
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="options">
                                    {option:item.afbeelding}
                                        <p><img src="{$FRONTEND_FILES_URL}/de_handswagens/afbeelding/600x600/{$item.afbeelding}"/></p>
                                    {/option:item.afbeelding}
                                    <p>
                    ...
                    <td id="sidebar">
                            ...
                            <div class="box">
                                ...
                                <div class="options">
                                    {$chkVerkocht} <label for="verkocht">{$lblVerkocht|ucfirst} </label> {$chkVerkochtError}
                                </div>
                            </div>
