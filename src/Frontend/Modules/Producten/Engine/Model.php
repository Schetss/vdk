...
namespace Frontend\Modules\Producten\Engine;
...
class Model
{
    ...
    public static function get($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Producten', 'Detail') . '/' . $item['url'];
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $detailUrl = Navigation::getURLForBlock('Producten', 'Detail');
    ...
    public static function getAllCategory1()
    {
        $return = (array) FrontendModel::get('database')->getRecords(
            'SELECT id, titel AS title, tekst as content, link as link, linktekst as linktext, afbeelding as img
             FROM producten
             WHERE category_id = 1
             AND publiceren = TRUE
    ...
    public static function getCategory($URL)
    {
        ...
        // create full url
        $item['full_url'] = Navigation::getURLForBlock('Producten', 'category') . '/' . $item['url'];
