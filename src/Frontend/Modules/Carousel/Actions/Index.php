...
namespace Frontend\Modules\Carousel\Actions;
...
class Index extends Block
{
    ...
    private function getData()
    {
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Carousel');
        $this->pagination['limit'] = $this->get('fork.settings')->get('Carousel', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendCarouselModel::getAllCount();
        ...
        // get articles
        $this->items = FrontendCarouselModel::getAll(
