...
/**
 * This is the category-action, it will display the overview of Contact categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendContactModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Contact', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Contact', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendContactModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendContactModel::getAllByCategory(
