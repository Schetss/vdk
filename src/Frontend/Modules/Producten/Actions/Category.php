...
namespace Frontend\Modules\Producten\Actions;
...
/**
 * This is the category-action, it will display the overview of Producten categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendProductenModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Producten', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Producten', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendProductenModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendProductenModel::getAllByCategory(
