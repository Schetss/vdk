			...
			<div class="grid-item-content block">
				<div class="stacked">
                    ...
                    <li class="rrssb-facebook">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u={$SITE_URL}/nl/vacatures" class="popup">
                    ...
                    <li class="rrssb-linkedin">
                        ...
                        <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={$SITE_URL}/nl/vacatures&amp;title=Vacatures&amp;" class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                    ...
                    <li class="rrssb-twitter">
                        <!-- Replace href with your Meta and URL information  -->
                        <a href="http://twitter.com/home?status=Vacatures%20{$SITE_URL}/nl/vacatures" class="popup">
                            <span class="rrssb-icon">
