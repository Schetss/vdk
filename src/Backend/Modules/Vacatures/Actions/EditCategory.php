...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        $this->record = BackendVacaturesModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Vacatures\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
