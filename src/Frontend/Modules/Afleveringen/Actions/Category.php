...
namespace Frontend\Modules\Afleveringen\Actions;
...
/**
 * This is the category-action, it will display the overview of Afleveringen categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendAfleveringenModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Afleveringen', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Afleveringen', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendAfleveringenModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendAfleveringenModel::getAllByCategory(
