...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendProductenModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendProductenModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->meta->setUrlCallBack('Backend\Modules\Producten\Engine\Model', 'getUrl', array($this->record['id']));
