...
namespace Frontend\Modules\CallToAction\Actions;
...
/**
 * This is the category-action, it will display the overview of Call To Action categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendCallToActionModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('CallToAction', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('CallToAction', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendCallToActionModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendCallToActionModel::getAllByCategory(
