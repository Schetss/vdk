...
class EditCategory extends ActionEdit
{
    ...
    private function getData()
    {
        ...
        $this->record = BackendAfleveringenModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Afleveringen\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
