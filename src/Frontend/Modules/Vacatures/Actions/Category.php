...
namespace Frontend\Modules\Vacatures\Actions;
...
/**
 * This is the category-action, it will display the overview of Vacatures categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendVacaturesModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Vacatures', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Vacatures', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendVacaturesModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendVacaturesModel::getAllByCategory(
