...
namespace Frontend\Modules\Service\Actions;
...
/**
 * This is the category-action, it will display the overview of Service categories
 *
...
class Category extends Block
{
    ...
    private function getData()
    {
        ...
        // get category
        $this->category = FrontendServiceModel::getCategory($this->URL->getParameter(0));
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Service', 'category') . '/' . $this->category['url'];

        $this->pagination['limit'] = $this->get('fork.settings')->get('Service', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendServiceModel::getCategoryCount($this->category['id']);
        ...
        // get items
        $this->items = FrontendServiceModel::getAllByCategory(
