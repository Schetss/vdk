...
class Index extends Block
{
    ...
    private function getData()
    {
        ...
        // set URL and limit
        $this->pagination['url'] = Navigation::getURLForBlock('Afleveringen');
        $this->pagination['limit'] = $this->get('fork.settings')->get('Afleveringen', 'overview_num_items', 10);

        // populate count fields in pagination
        $this->pagination['num_items'] = FrontendAfleveringenModel::getAllCount();
        ...
        // get articles
        $this->items = FrontendAfleveringenModel::getAll(
